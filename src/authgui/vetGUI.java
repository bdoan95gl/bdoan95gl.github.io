 ...
 */
package authgui;
public class vetGUI extends javax.swing.JFrame {

    /**
     * Creates new form vetGUI
     */
    public vetGUI() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vetGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
